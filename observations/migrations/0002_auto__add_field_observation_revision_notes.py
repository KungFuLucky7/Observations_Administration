...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Observation.revision_notes'
        db.add_column(u'observations_observation', 'revision_notes',
                      self.gf('django.db.models.fields.TextField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Observation.revision_notes'
        db.delete_column(u'observations_observation', 'revision_notes')
