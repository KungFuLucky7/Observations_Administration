...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Observation.pub_date'
        db.alter_column(u'observations_observation', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 12, 4, 0, 0)))

    def backwards(self, orm):

        # Changing field 'Observation.pub_date'
        db.alter_column(u'observations_observation', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
